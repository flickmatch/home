...
interface JerseyProps {
  ...
  number?: string; // Optional prop with default value
}

const colorMap: { [key: string]: { numberColor?: string; fillColor?: string } } = {
  Black: { numberColor: '#FFFFFF', fillColor: '#3333333' },
  White: { numberColor: '#000000', fillColor: '#FFFFFF' },
  Red: { numberColor: '#FFFFFF', fillColor: '#D33115' },
  Blue: { numberColor: '#ffffff', fillColor: '#009CE0' },
...
const Jersey: React.FC<JerseyProps> = ({ color, number = '00', ...props }) => (
  <svg
  ...
  >
    ...
    <text
      ...
      fontSize="75"
      fontWeight="bold"
      fill={colorMap[color || 'Bibs']?.numberColor}
    >
      {number}
    </text>
  </svg>
