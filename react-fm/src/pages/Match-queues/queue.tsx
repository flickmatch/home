...
import { FlexBox, Box } from '@/components/styled';
        ...
        <Accordion style={{background: '#1a1919', fontFamily: 'serif'}}>
          ...
          >
            <FlexBox style={{ flexFlow: 'column', width: '100%'}}>
              <FlexBox style={{width: '100%', alignItems: 'center', justifyContent: 'space-between', marginBottom: 5}}>
                <Typography style={{color: '#fff', fontWeight: 'bold', fontSize: 21, display: 'flex', alignItems: 'center'}}><SportsSoccerIcon style={{marginRight: 5, color: 'rgb(76, 233, 90)'}} />Gallant Play Arena South City</Typography>
                ...
                <Grid container spacing={{ xs: 2, md: 3 }} columns={{ xs: 4, sm: 8, md: 12 }} style={{marginLeft: 20}}>
                  <Grid item xs={2} sm={4} md={4}>
                    <Typography style={{color: '#4CE95A', fontSize: 18, fontWeight: 'bold'}}>
                      Price <span style={{color: '#fff', marginLeft: 15}}><CurrencyRupeeSharp style={{fontSize: 22, marginBottom: -4}}/>200</span>
                    </Typography>
                  </Grid>
                  <Grid item xs={2} sm={4} md={4}>
                    <Typography style={{color: '#4CE95A', fontSize: 18, fontWeight: 'bold'}}>
          ...
          <AccordionDetails>
            <Box style={{marginTop: 20, marginLeft: 25}} sx={{ flexGrow: 1 }}>
              ...
              <Grid container spacing={{ xs: 2, md: 3 }} columns={{ xs: 4, sm: 8, md: 12 }}>
                  <Grid item xs={2} sm={4} md={4} style={{display: 'flex', alignItems: 'center'}}>
                    <Avatar style={{marginRight: 15}} alt="Remy Sharp" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS1gptEOLWU_ZFZQGMwF_EzTYAvGmeerm5aqZJG9hnWAA&s" />
                    <Typography style={{color: '#fff', fontSize: 16, fontWeight: 'bold'}}>
                      Abhishek
                    </Typography>
                  </Grid>
                  <Grid item xs={2} sm={4} md={4} style={{display: 'flex', alignItems: 'center'}}>
                    <Avatar style={{marginRight: 15}} alt="Remy Sharp" src="https://pbs.twimg.com/media/FoUoGo3XsAMEPFr?format=jpg&name=4096x4096" />
                    <Typography style={{color: '#fff', fontSize: 16, fontWeight: 'bold'}}>
                      Uday
                    </Typography>
                  </Grid>
                  <Grid item xs={2} sm={4} md={4} style={{display: 'flex', alignItems: 'center'}}>
                    <Avatar style={{marginRight: 15}} alt="Remy Sharp" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRIYZ5Ug1CDMppuput1FGd-kwYNoZwcJwDY2fCPmlsK8Q&s" />
                    <Typography style={{color: '#fff', fontSize: 16, fontWeight: 'bold'}}>
                      Nishant
                    </Typography>
                  </Grid>
            ...
            <Box style={{marginTop: 20, marginLeft: 25}} sx={{ flexGrow: 1 }}>
              <Grid container spacing={{ xs: 2, md: 3 }} columns={{ xs: 4, sm: 8, md: 12 }}>
                  <Grid item xs={2} sm={4} md={4} style={{display: 'flex', alignItems: 'center'}}>
                    <Avatar style={{marginRight: 15}} alt="Remy Sharp" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRp1f10Ha21IUV3t0oABQAcNI1ncGs5o3ohWA&usqp=CAU" />
                    <Typography style={{color: '#fff', fontSize: 16, fontWeight: 'bold'}}>
                      Shubham
                    </Typography>
                  </Grid>
                  <Grid item xs={2} sm={4} md={4} style={{display: 'flex', alignItems: 'center'}}>
                    <Avatar style={{marginRight: 15}} alt="Remy Sharp" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS1OmtCTmW8kQi4I5LnRFkvVIhdKIs2RSnVTQ&usqp=CAU" />
                    <Typography style={{color: '#fff', fontSize: 16, fontWeight: 'bold'}}>
                      Abhinav
                    </Typography>
                  </Grid>
                  <Grid item xs={2} sm={4} md={4} style={{display: 'flex', alignItems: 'center'}}>
                    <Avatar style={{marginRight: 15}} alt="Remy Sharp" src="https://cdn.futbin.com/content/fifa19/img/players/p246525.png?v=23" />
                    <Typography style={{color: '#fff', fontSize: 16, fontWeight: 'bold'}}>
                      Vaibhav
                    </Typography>
                  </Grid>
            ...
            <Box style={{marginTop: 20, marginLeft: 25}} sx={{ flexGrow: 1 }}>
              <Grid container spacing={{ xs: 2, md: 3 }} columns={{ xs: 4, sm: 8, md: 12 }}>
                  <Grid item xs={2} sm={4} md={4} style={{display: 'flex', alignItems: 'center'}}>
                    <Avatar style={{marginRight: 15}} alt="Remy Sharp" src="https://i.pinimg.com/originals/9a/23/b0/9a23b044d3ae8bb33087200aaf983c15.jpg" />
                    <Typography style={{color: '#fff', fontSize: 16, fontWeight: 'bold'}}>
                      Harsh
                    </Typography>
                  </Grid>
            ...
            <Box style={{marginTop: 20, marginLeft: 25}} sx={{ flexGrow: 1 }}>
              ...
              <Grid container spacing={{ xs: 2, md: 3 }} columns={{ xs: 4, sm: 8, md: 12 }}>
                  <Grid item xs={2} sm={4} md={4} style={{display: 'flex', alignItems: 'center'}}>
                    <Avatar style={{marginRight: 15}} alt="Remy Sharp" src="https://i.pinimg.com/736x/f0/8e/1e/f08e1ec7ab1589419d515b7fbb60d88b.jpg" />
                    <Typography style={{color: '#fff', fontSize: 16, fontWeight: 'bold'}}>
                      Sahil
                    </Typography>
                  </Grid>
                  <Grid item xs={2} sm={4} md={4} style={{display: 'flex', alignItems: 'center'}}>
                    <Avatar style={{marginRight: 15}} alt="Remy Sharp" src="https://cdn.futbin.com/content/fifa23/img/players/p50529093.png" />
                    <Typography style={{color: '#fff', fontSize: 16, fontWeight: 'bold'}}>
                      Shubham
                    </Typography>
                  </Grid>
                  <Grid item xs={2} sm={4} md={4} style={{display: 'flex', alignItems: 'center'}}>
                    <Avatar style={{marginRight: 15}} alt="Remy Sharp" src="https://e0.pxfuel.com/wallpapers/762/930/desktop-wallpaper-allison-becker-baseball-glove-sports-jersey-thumbnail.jpg" />
                    <Typography style={{color: '#fff', fontSize: 16, fontWeight: 'bold'}}>
                      Gourav
                    </Typography>
                  </Grid>
