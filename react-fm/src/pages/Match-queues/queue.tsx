...
=======
      <div className={styles.container}>
        <Typography className={styles.cityName}>
          Gurugram <img src={delhiIcon} alt="" />
        </Typography>
...
=======
            <FlexBox className={styles.flexbox}>
              <FlexBox className={styles.area}>
                <Typography className={styles.areaName}>
                  <SportsSoccerIcon className={styles.sportsIcon} />
                  Gallant Play Arena South City
                </Typography>
                {isPortrait ? null : (
              ...
              <FlexBox className={styles.eventDetails} sx={{ flexGrow: 1 }}>
                <Grid
                  ...
                  className={styles.queueDetails1}
                >
...
<<<<<<< HEAD
          ...
          <AccordionDetails>
            ...
            <Box style={{marginTop: 20, marginLeft: 25}} sx={{ flexGrow: 1 }}>
              <Grid container spacing={{ xs: 2, md: 3 }} columns={{ xs: 4, sm: 8, md: 12 }}>
                  <Grid item xs={2} sm={4} md={4} style={{display: 'flex', alignItems: 'center'}}>
                    <Avatar style={{marginRight: 15}} alt="profile" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRp1f10Ha21IUV3t0oABQAcNI1ncGs5o3ohWA&usqp=CAU" />
                    <Typography id="names">
                      Shubham
                    </Typography>
                  </Grid>
                  <Grid item xs={2} sm={4} md={4} style={{display: 'flex', alignItems: 'center'}}>
                    <Avatar style={{marginRight: 15}} alt="profile" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS1OmtCTmW8kQi4I5LnRFkvVIhdKIs2RSnVTQ&usqp=CAU" />
                    <Typography id="names">
                      Abhinav
                    </Typography>
                  </Grid>
                  <Grid item xs={2} sm={4} md={4} style={{display: 'flex', alignItems: 'center'}}>
                    <Avatar style={{marginRight: 15}} alt="profile" src="https://cdn.futbin.com/content/fifa19/img/players/p246525.png?v=23" />
                    <Typography id="names">
                      Vaibhav
                    </Typography>
                  </Grid>
            ...
            <Box style={{marginTop: 20, marginLeft: 25}} sx={{ flexGrow: 1 }}>
              <Grid container spacing={{ xs: 2, md: 3 }} columns={{ xs: 4, sm: 8, md: 12 }}>
                  <Grid item xs={2} sm={4} md={4} style={{display: 'flex', alignItems: 'center'}}>
                    <Avatar style={{marginRight: 15}} alt="profile" src="https://i.pinimg.com/originals/9a/23/b0/9a23b044d3ae8bb33087200aaf983c15.jpg" />
                    <Typography id="names">
                      Harsh
                    </Typography>
                  </Grid>
            ...
            <Box style={{marginTop: 20, marginLeft: 25}} sx={{ flexGrow: 1 }}>
              ...
              <Grid container spacing={{ xs: 2, md: 3 }} columns={{ xs: 4, sm: 8, md: 12 }}>
                  <Grid item xs={2} sm={4} md={4} style={{display: 'flex', alignItems: 'center'}}>
                    <Avatar style={{marginRight: 15}} alt="profile" src="https://i.pinimg.com/736x/f0/8e/1e/f08e1ec7ab1589419d515b7fbb60d88b.jpg" />
                    <Typography id="names">
                      Sahil
                    </Typography>
                  </Grid>
                  <Grid item xs={2} sm={4} md={4} style={{display: 'flex', alignItems: 'center'}}>
                    <Avatar style={{marginRight: 15}} alt="profile" src="https://cdn.futbin.com/content/fifa23/img/players/p50529093.png" />
                    <Typography id="names">
                      Shubham
                    </Typography>
                  </Grid>
                  <Grid item xs={2} sm={4} md={4} style={{display: 'flex', alignItems: 'center'}}>
                    <Avatar style={{marginRight: 15}} alt="profile" src="https://e0.pxfuel.com/wallpapers/762/930/desktop-wallpaper-allison-becker-baseball-glove-sports-jersey-thumbnail.jpg" />
                    <Typography id="names">
                      Gourav
                    </Typography>
                  </Grid>
...
=======
              <FlexBox className={styles.eventDetails} sx={{ flexGrow: 1 }}>
                <Grid
                  ...
                  spacing={{ xs: 2, md: 3 }}
                  columns={{ xs: 4, sm: 8, md: 12 }}
                  className={styles.queueDetails2}
                >
                  <Grid item xs={4} sm={4} md={4}>
                    <Typography className={styles.title}>
          ...
          <AccordionDetails>
            <Box className={styles.box} sx={{ flexGrow: 1 }}>
              ...
              <Grid container spacing={{ xs: 2, md: 3 }} columns={{ xs: 4, sm: 8, md: 12 }}>
                <Grid item xs={2} sm={4} md={4} className={styles.grid}>
                  ...
                  />
                  <Typography className={styles.playerNames}>Abhishek</Typography>
                </Grid>
                <Grid item xs={2} sm={4} md={4} className={styles.grid}>
                  <Avatar
                    className={styles.avatar}
                  ...
                  />
                  <Typography className={styles.playerNames}>Uday</Typography>
                </Grid>
                <Grid item xs={2} sm={4} md={4} className={styles.grid}>
                  <Avatar
                    className={styles.avatar}
                    alt="profile"
                    src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRIYZ5Ug1CDMppuput1FGd-kwYNoZwcJwDY2fCPmlsK8Q&s"
                  />
                  <Typography className={styles.playerNames}>Nishant</Typography>
                </Grid>
              </Grid>
            </Box>
            <Box className={styles.box} sx={{ flexGrow: 1 }}>
              <Grid container spacing={{ xs: 2, md: 3 }} columns={{ xs: 4, sm: 8, md: 12 }}>
                <Grid item xs={2} sm={4} md={4} className={styles.grid}>
                  <Avatar
                    className={styles.avatar}
                    alt="profile"
                    src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRp1f10Ha21IUV3t0oABQAcNI1ncGs5o3ohWA&usqp=CAU"
                  />
                  <Typography className={styles.playerNames}>Shubham</Typography>
                </Grid>
                <Grid item xs={2} sm={4} md={4} className={styles.grid}>
                  <Avatar
                    className={styles.avatar}
                    alt="profile"
                    src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS1OmtCTmW8kQi4I5LnRFkvVIhdKIs2RSnVTQ&usqp=CAU"
                  />
                  <Typography className={styles.playerNames}>Abhinav</Typography>
                </Grid>
                <Grid item xs={2} sm={4} md={4} className={styles.grid}>
                  <Avatar
                    className={styles.avatar}
                    alt="profile"
                    src="https://cdn.futbin.com/content/fifa19/img/players/p246525.png?v=23"
                  />
                  <Typography className={styles.playerNames}>Vaibhav</Typography>
                </Grid>
              </Grid>
            </Box>
            <Box className={styles.box} sx={{ flexGrow: 1 }}>
              <Grid container spacing={{ xs: 2, md: 3 }} columns={{ xs: 4, sm: 8, md: 12 }}>
                <Grid item xs={2} sm={4} md={4} className={styles.grid}>
                  ...
                  />
                  <Typography className={styles.playerNames}>Harsh</Typography>
                </Grid>
                <Grid item xs={2} sm={4} md={4} className={styles.grid}>
                  <AccountCircleIcon className={styles.accountIcon} />
                  <Typography className={styles.playerNames}>(Empty)</Typography>
                </Grid>
                <Grid item xs={2} sm={4} md={4} className={styles.grid}>
                  <AccountCircleIcon className={styles.accountIcon} />
                  <Typography className={styles.playerNames}>(Empty)</Typography>
            ...
            <Box className={styles.box} sx={{ flexGrow: 1 }}>
              <Typography className={styles.unReserved}>Un Reserved Players</Typography>
              <Grid container spacing={{ xs: 2, md: 3 }} columns={{ xs: 4, sm: 8, md: 12 }}>
                <Grid item xs={2} sm={4} md={4} className={styles.grid}>
                  <Avatar
                    className={styles.avatar}
                  ...
                  />
                  <Typography className={styles.playerNames}>Sahil</Typography>
                </Grid>
                <Grid item xs={2} sm={4} md={4} className={styles.grid}>
                  <Avatar
                    className={styles.avatar}
                    alt="profile"
                    src="https://cdn.futbin.com/content/fifa23/img/players/p50529093.png"
                  />
                  <Typography className={styles.playerNames}>Shubham</Typography>
                </Grid>
                <Grid item xs={2} sm={4} md={4} className={styles.grid}>
                  <Avatar
                    className={styles.avatar}
                    alt="profile"
                    src="https://e0.pxfuel.com/wallpapers/762/930/desktop-wallpaper-allison-becker-baseball-glove-sports-jersey-thumbnail.jpg"
                  />
                  <Typography className={styles.playerNames}>Gourav</Typography>
                </Grid>
              </Grid>
>>>>>>> 53a0d7d001e5b1e75d1de956b83898c1d1e03566
            </Box>
...
=======
      <div className={styles.container}>
        <Typography className={styles.cityName}>
          Hyderabad <img src={charminar} alt="" />
        </Typography>
        <Accordion className={styles.accordion}>
>>>>>>> 53a0d7d001e5b1e75d1de956b83898c1d1e03566
          <AccordionSummary
...
<<<<<<< HEAD
          ...
          <AccordionDetails>
            <Box style={{marginTop: 20, marginLeft: 25}} sx={{ flexGrow: 1 }}>
              ...
              <Grid container spacing={{ xs: 2, md: 3 }} columns={{ xs: 4, sm: 8, md: 12 }}>
                  <Grid item xs={2} sm={4} md={4} style={{display: 'flex', alignItems: 'center'}}>
                    <Avatar style={{marginRight: 15}} alt="profile" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS1gptEOLWU_ZFZQGMwF_EzTYAvGmeerm5aqZJG9hnWAA&s" />
                    <Typography style={{color: '#fff', fontSize: 16, fontWeight: 'bold'}}>
                      Abhishek
                    </Typography>
                  </Grid>
                  <Grid item xs={2} sm={4} md={4} style={{display: 'flex', alignItems: 'center'}}>
                    <Avatar style={{marginRight: 15}} alt="profile" src="https://pbs.twimg.com/media/FoUoGo3XsAMEPFr?format=jpg&name=4096x4096" />
                    <Typography style={{color: '#fff', fontSize: 16, fontWeight: 'bold'}}>
                      Uday
                    </Typography>
                  </Grid>
                  <Grid item xs={2} sm={4} md={4} style={{display: 'flex', alignItems: 'center'}}>
                    <Avatar style={{marginRight: 15}} alt="profile" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRIYZ5Ug1CDMppuput1FGd-kwYNoZwcJwDY2fCPmlsK8Q&s" />
                    <Typography style={{color: '#fff', fontSize: 16, fontWeight: 'bold'}}>
                      Nishant
                    </Typography>
                  </Grid>
